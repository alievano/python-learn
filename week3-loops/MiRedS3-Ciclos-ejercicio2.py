...
while continuar:
    ...
    print("2. Modificar nombre de perfil")
    print("3. Salir")
    opcion = str(input("Ingresa una opción: "))
    ...
    #Así, en la siguiente iteración el ciclo terminará
        ...
        nombre = input("Ingresa un nuevo nombre de perfil: ")
        print("Nombre modificado | Nombre:  ", nombre)
    elif opcion == "3":
        continuar = False
    else:
        print()
